<?php
  ...
  drupal_add_js(drupal_get_path('theme', 'research7') . '/js/jquery-ui-1.8.1.custom.min.js', 'theme');
  drupal_add_css(drupal_get_path('theme', 'research7') . '/css/redmond/jquery-ui-1.8.1.custom.css', 'theme');
  drupal_add_css(drupal_get_path('theme', 'research7') . '/jquery.ui.core.css', 'theme');
  drupal_add_css(drupal_get_path('theme', 'research7') . '/jquery.ui.tabs.css', 'theme');
  drupal_add_css(drupal_get_path('theme', 'research7') . '/jquery.ui.theme.css', 'theme');
